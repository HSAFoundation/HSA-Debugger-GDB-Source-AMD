...
//==============================================================================
#ifndef __DBGINFODWARFPARSER_H
#define __DBGINFODWARFPARSER_H
...
/// Dwarf variable encoding
enum DwarfVariableEncoding
{
    DV_POINTER_ENCODING,
    DV_BOOL_ENCODING,
    DV_FLOAT_ENCODING,
...
{
public:
    KernelBinary(void* pBinaryData, size_t binarySize);
    ...
    void setBinary(void* pBinaryData, size_t binarySize);
    ...
    void* m_pBinaryData; ///< A buffer containing the elf binary data
...
public:
    ...
    typedef DwarfVariableInfo::VariableValueType DwarfVariableValueType;
    typedef DwarfVariableInfo::VariableIndirection DwarfVariableIndirectionType;
    //@}
...
private:
    ...
    static DwarfVariableValueType GetVariableValueTypeFromTAG(int dwarfTAG);
