...
typedef struct _HsailBreakpointRequest HsailBreakpointRequest;
...
struct breakpoint
  {
    ...
    /* For an HSAIL breakpoint, the request that is used to create
     * the breakpoint, it is used to print the line information
     *  */
    HsailBreakpointRequest* hsail_bp_request;

    /* HSAIL Program counter */
    int hsail_pc;
